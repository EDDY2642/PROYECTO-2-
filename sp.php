	...
	<header>
		<div class="contenedor">
			...
			<a href="cliente.php" class="activo">Inicio</a>
				...
				<a href="registro1.php">Cerrar sesión</a>
...
<div class="pelicula">
	...
	<form action="action_page" method="post">
		  ...
		  <h1 class="h">SPIDER-MAN: NO WAY HOME</h1>
<br>
                  <h2 class="h">Sinopsis</h2>
		  <p class="p"> a quien se le ofrece la posibilidad de pelear por el título mundial de los pesos pesados. Con una gran fuerza de voluntad,  se prepara concienzudamente para el combate y de la misma manera para los cambios que acabarán produciéndose en su vida.</p>
<br>
...
<ul>
<br>
    <a class="boton_1" href="sala.php">Comprar boletos</a>
